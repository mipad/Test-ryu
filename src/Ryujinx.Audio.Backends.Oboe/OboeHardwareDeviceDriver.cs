...
namespace Ryujinx.Audio.Backends.Oboe
{
    public class OboeHardwareDeviceDriver : IHardwareDeviceDriver, IDisposable
    {
        ...
        private readonly ManualResetEvent _updateRequiredEvent = new ManualResetEvent(false);
        private readonly ConcurrentDictionary<OboeAudioSession, byte> _sessions = new ConcurrentDictionary<OboeAudioSession, byte>();
        ...
        {
            return channelCount == 1 || channelCount == 2 || channelCount == Constants.ChannelCountMax;
        }
        ...
        private class OboeAudioSession : HardwareDeviceSessionOutputBase
        {
            ...
            private readonly ConcurrentQueue<OboeAudioBuffer> _queuedBuffers = new ConcurrentQueue<OboeAudioBuffer>();

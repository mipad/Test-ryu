namespace Ryujinx.Graphics.GAL
{
    ...
    public static class FormatExtensions
    {
        ...
        /// </summary>
        /// <param name="format">Texture format</param>
        /// <returns>True if the texture format is compressed, false otherwise</returns>
        public static bool IsCompressed(this Format format)
        {
            return format.IsBc1() || format.IsBc2() || format.IsBc3() || format.IsBc4() || 
                   format.IsBc5() || format.IsBc6() || format.IsBc7() || format.IsEtc2() || 
                   format.IsAstc();
        }

        /// <summary>
        /// Checks if the texture format is a BC1 format.
        /// </summary>
        /// <param name="format">Texture format</param>
        /// <returns>True if the texture format is a BC1 format, false otherwise</returns>
        public static bool IsBc1(this Format format)
        {
            switch (format)
            {
                case Format.Bc1RgbaUnorm:
        ...
        /// <summary>
        /// Checks if the texture format is a BC2 format.
        /// </summary>
        /// <param name="format">Texture format</param>
        /// <returns>True if the texture format is a BC2 format, false otherwise</returns>
        public static bool IsBc2(this Format format)
        {
            switch (format)
            {
                case Format.Bc2Unorm:
        ...
        /// <summary>
        /// Checks if the texture format is a BC3 format.
        /// </summary>
        /// <param name="format">Texture format</param>
        /// <returns>True if the texture format is a BC3 format, false otherwise</returns>
        public static bool IsBc3(this Format format)
        {
            switch (format)
            {
                case Format.Bc3Unorm:
        ...
        /// <summary>
        /// Checks if the texture format is a BC4 format.
        /// </summary>
        /// <param name="format">Texture format</param>
        /// <returns>True if the texture format is a BC4 format, false otherwise</returns>
        ...
        /// <summary>
        /// Checks if the texture format is a BC5 format.
        /// </summary>
        /// <param name="format">Texture format</param>
        /// <returns>True if the texture format is a BC5 format, false otherwise</returns>
        ...
        /// <summary>
        /// Checks if the texture format is a BC6 format.
        /// </summary>
        /// <param name="format">Texture format</param>
        /// <returns>True if the texture format is a BC6 format, false otherwise</returns>
        public static bool IsBc6(this Format format)
        {
            switch (format)
            {
                case Format.Bc6HSfloat:
        ...
        /// <summary>
        /// Checks if the texture format is a BC7 format.
        /// </summary>
        /// <param name="format">Texture format</param>
        /// <returns>True if the texture format is a BC7 format, false otherwise</returns>
        public static bool IsBc7(this Format format)
        {
            switch (format)
            {
                case Format.Bc7Unorm:

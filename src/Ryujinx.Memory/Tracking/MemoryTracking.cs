...
namespace Ryujinx.Memory.Tracking
{
    ...
    public class MemoryTracking
    {
        ...
        {
            // 新增：跳过音频区域处理
            if (_isAudioRegion != null && _isAudioRegion(va, size))
            {
                return;
            }
